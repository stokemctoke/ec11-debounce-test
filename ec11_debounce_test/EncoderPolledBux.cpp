// Encoder method: POLLED + CONFIRMED BUXTRONIX  (the proven default)
//
// Strategy:
...
//
// Tradeoff: very robust against bounce; adds 1 sample of latency (~200 us).
// This is what we landed on after the early stages failed on a noisy EC11.
...
void polledBux_deinit() {
  // Pure polling — nothing to release.
}

int32_t polledBux_getPos() { return pos; }
